...
#End Region
    ...
    Private Sub CopyrightAndLicenseToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsCopyrightAndLicense.Click
        ...
        MessageBox.Show("A Viewer for Windows" & vbCrLf &
                        "Copyright Rob Latour, 2022" & vbCrLf & vbCrLf &
                        "License: " & vbCrLf &
                        "MIT" & vbCrLf & vbCrLf &
                        "Source: " & vbCrLf &
                        "https://github.com/roblatour/AViewerForWindows" & vbCrLf & vbCrLf &
                        "Credits:" & vbCrLf &
                        "A Viewer for Window uses ImageMagick: Magick.NET" & vbCrLf &
                        "ImageMagick: Magick.NET is licensed under Apache License Version 2.0.",
