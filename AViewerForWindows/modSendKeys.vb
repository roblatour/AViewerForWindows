...
Module KeyboardSend
    ...
    '    KeyboardSend.KeyDown(Keys.Up)
    '    KeyboardSend.KeyUp(Keys.LWin)
    '    KeyboardSend.KeyUp(Keys.Up)
    ...
    '    KeyboardSend.KeyDown(Keys.LWin)
    '    KeyboardSend.KeyDown(Keys.Down)
    '    KeyboardSend.KeyUp(Keys.LWin)
    '    KeyboardSend.KeyUp(Keys.Down)
    ...
    Private Sub SoftClearModifiers()
        ...
        ' KeyboardSend.KeyPress(VirtualKeyCode.Invalid) 'seems to be required to clear out a buffer or something like that.
...
DoneWithThisKey:
    ...
    Friend Sub GetSimpleKeysVirtualKeyCode(ByVal InputString As String, ByRef VirtKeyCode As VirtualKeyCode, ByRef ShiftRequired As Boolean, ByRef AltRequired As Boolean, ByRef CtrlRequired As Boolean)
        ...
        For x = 1 To MyKeyBoardKeys.Length - 1
